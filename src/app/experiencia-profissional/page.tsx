  ...
  const experiencias = [
    {
      ...
      descricao: "Atuei como auxiliar administrativo, realizando tarefas de apoio à equipe, organização de documentos e atendimento ao público.",
      tecnologias: ["Atendimento ao Público", "Organização", "Trabalho em Equipe"]
    },
    {
      empresa: "Atual",
      cargo: "Auxiliar de Faturamento",
      periodo: "Atual",
      descricao: "Responsável por atividades de faturamento, conferência de documentos e apoio à equipe administrativa.",
      tecnologias: ["Faturamento", "Conferência", "Sistemas Administrativos"]
    }
  ]
      ...
      <div className="space-y-8">
        {experiencias.map((exp, index) => (
          <div key={index} className="bg-white p-6 rounded-lg shadow-md border border-gray-200">
            ...
            <p className="text-gray-500 mb-4">{exp.periodo}</p>
